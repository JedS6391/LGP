...
import nz.co.jedsimson.lgp.test.mocks.MockProgramGenerator
...
object ProgramAndInstructionGeneratorFeature : Spek({
    ...
    Feature("Program and instruction generation") {
        Scenario("Generating a sequence of programs") {
            ...
            Given("A program generator") {
                programGenerator = MockProgramGenerator(MockEnvironment())
            }
