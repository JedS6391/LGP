 ...
 * @see [Dataset]
 */
open class Sample<out TFeature>(val features: List<Feature<TFeature>>) {
 ...
 *
 * @param TInput The type of the features in the input vector.
 * @param TOutput The type of outputs.
 ...
 */
open class Dataset<out TInput, out TOutput>(
        val inputs: List<Sample<TInput>>,
